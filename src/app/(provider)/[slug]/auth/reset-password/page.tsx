...
const ResetPasswordPage = ({ params }: { params: { slug: string } }) => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50/50 px-4">
      <div className="w-full max-w-md bg-white p-8 rounded-3xl shadow-xl text-center">
        ...
        <p className="text-gray-500 mb-6">Fitur reset kata sandi untuk agensi ({params.slug}) sedang dalam pengembangan.</p>
        <button 
