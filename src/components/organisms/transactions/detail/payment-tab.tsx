      ...
      {transaction.paymentStatus === 'CHECKING' && (
        <Card className="bg-gradient-to-r from-warning-50 to-white border-warning-100/50 p-6 rounded-[2rem] shadow-sm relative overflow-hidden group">
          ...
          <div className="flex items-center gap-5 relative z-10">
            <div className="size-14 rounded-2xl bg-warning-500 flex items-center justify-center text-white shadow-xl shadow-warning-500/20 shrink-0 animate-pulse">
              <ShieldCheck className="size-7" />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <p className="text-base font-black text-foreground tracking-tight">{t('detail.proofReceived')}</p>
            ...
            <Badge className="bg-warning-500 text-white border-0 text-[10px] px-4 py-1.5 rounded-full font-black uppercase tracking-widest shadow-lg shadow-warning-500/20">
              ...
              {i < PAYMENT_STEPS.length - 1 && (
                <div
                  className={cn(
                    ...
                    i < activeIdx ? 'bg-primary-default shadow-[0_0_10px_rgba(var(--primary-default),0.5)]' : 'bg-gray-100'
                  )}
                />
              )}
            </div>
              ...
              <div className="md:col-span-7 p-8 sm:p-10 space-y-8 flex flex-col justify-center bg-gradient-to-br from-white to-gray-50/30">
                <div className="grid grid-cols-2 gap-x-8 gap-y-10">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-base font-black text-primary-default sm:text-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm font-bold text-foreground truncate sm:text-base">
                ...
                <div className="pt-6 border-t border-gray-100/50">
                  <div className="bg-white rounded-2xl p-4 border border-gray-100 flex items-center justify-between shadow-sm">
                    <div className="flex flex-col gap-0.5">
                      <p className="text-[10px] font-black text-muted-foreground/40 uppercase tracking-[0.15em]">{t('detail.checkStatus')}</p>
                      <p className="text-xs font-bold text-foreground/60">{t('detail.systemVerification')}</p>
                    </div>
                    <Badge className={cn(
