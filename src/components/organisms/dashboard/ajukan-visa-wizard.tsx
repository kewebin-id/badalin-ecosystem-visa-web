...
import { Drawer, DrawerContent, DrawerHeader, DrawerTitle } from '@/components/atoms/drawer';
    ...
    return (
      <div className="flex flex-col h-full min-h-[400px]">
        ...
        >
          ...
          <h3 className="text-2xl font-black text-dark-950 mb-3 tracking-tight">{stageTitle}</h3>
        ...
        <div className="flex gap-4 mt-8">
          {currentStage > 1 && (
            <Button
              variant="transparent"
              onClick={handleBack}
              className="flex-1 h-12 rounded-xl font-bold border border-gray-100"
            >
          ...
          <Button
            onClick={handleNext}
            className="flex-1 h-12 rounded-xl font-black shadow-lg shadow-primary-default/20 transition-all hover:scale-[1.02] active:scale-95"
          >
