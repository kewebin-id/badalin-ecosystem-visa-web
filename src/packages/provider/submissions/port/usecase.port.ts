...
export interface IProviderSubmissionsUseCase {
  ...
  addFlightManifest(id: string, payloads: IFlightManifestPayload[]): Promise<IUsecaseResponse<boolean>>;
  addHotelManifest(id: string, payloads: IHotelManifestPayload[]): Promise<IUsecaseResponse<boolean>>;
  addTransportManifest(id: string, payloads: ITransportManifestPayload[]): Promise<IUsecaseResponse<boolean>>;
  reviewSubmission(id: string, payload: IReviewSubmissionPayload): Promise<IUsecaseResponse<boolean>>;
}
